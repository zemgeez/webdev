...
export default class MCover extends Component {
  render() {
    return (
      <div className="bg-pink-50 mt-5">
        <div className="bg-blue-900 mb-5 mt-10 ml-20 w-fit px-12">
          <h1 className="font-bold text-xl py-3 text-white">Media Coverage </h1>
        </div>
        ...
        <div className="mx-40 grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-1 bg-orange-100">
          ...
          <div className="bg-blue-900 col-span-3 text-white text-5xl font-semibold pb-5">
            <h1 className="mt-6 ml-5">Shades Of Campus</h1>
          </div>
