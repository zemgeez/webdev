...
export default function CardTop(){
    return(<>
        ...
        <Card className="max-w-[1200px] flex flex-col   text-white mx-0 ">
            <CardBody className="  " >
            <div className=" flex flex-col h-1/1 w-full bg-white md:gap-4  bg-cover bg-center ">

                
            
                <img className="flex h-3/5 w-1/1" src="./to1.jpg" alt=""/>  
                
       

                <div className=" max-w absolute bottom-0 left-0 right-0 top-0 px-4 py-40 bg-gray-800 opacity-80 text-center">
                    <div className="w-full h-full flex flex-col justify-center items-center backdrop-blur-lg">
                        <h3 className="max-w text-5xl justify-center text-white font-bold">Where Dreams Become Reality !</h3>
                        <p className="mt-2 text-lg text-gray-300"> For you we brings the most thrilling and exciting events at NIT SILCHAR.</p>
                    </div>
                </div>

                <section className="w-full h-full bg-gray-500"></section>
            </div>
